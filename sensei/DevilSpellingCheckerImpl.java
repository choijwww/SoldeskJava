...
public class DevilSpellingCheckerImpl implements SpellingChecker, Dictionary {
	...
	private String [] wordsKorean = { "미움", "전쟁", "불행" };
	private String [] wordsEnglish = { "hate", "war", "unhappiness" };	
}
